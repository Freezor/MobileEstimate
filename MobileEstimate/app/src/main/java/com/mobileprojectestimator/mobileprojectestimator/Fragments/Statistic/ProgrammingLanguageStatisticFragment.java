 ...
 */
public class ProgrammingLanguageStatisticFragment extends StatisticFragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        ImageView dot5 = (ImageView) myLayout.findViewById(R.id.dot5);
        dot5.setBackgroundResource(R.drawable.circle_blue);

        tvTitle = (TextView) rootView.findViewById(R.id.tvTitle);
        tvTitle.setText(R.string.fragment_statistic_programming_language_title);

        mChart = (PieChart) rootView.findViewById(R.id.estimationMethodProjectsChart);

        // configure pie chart
        mChart.setUsePercentValues(true);
        mChart.setDescription("Programming Language Share");
