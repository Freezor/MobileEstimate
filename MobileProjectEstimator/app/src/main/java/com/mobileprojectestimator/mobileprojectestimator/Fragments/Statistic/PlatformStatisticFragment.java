...
public class PlatformStatisticFragment extends StatisticFragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        ImageView dot4 = (ImageView) myLayout.findViewById(R.id.dot4);
    ...
    private void addData()
    {
        ...
        ArrayList<PropertyProjects> values = databaseHelper.loadPropertyStatistic("Platforms", "Platform_id");
        ...
        // create pie data set
        PieDataSet dataSet = new PieDataSet(yVals1, "Platform Share");
