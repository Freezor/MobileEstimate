 ...
 */
public class PlatformStatisticFragment extends StatisticFragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        final ImageView dot4 = (ImageView) myLayout.findViewById(R.id.dot4);
        dot4.setBackgroundResource(R.drawable.circle_blue);

        tvTitle = (TextView) rootView.findViewById(R.id.tvTitle);
        tvTitle.setText(R.string.fragment_statistic_platform_title);

        mChart = (PieChart) rootView.findViewById(R.id.estimationMethodProjectsChart);

        // configure pie chart
        mChart.setUsePercentValues(true);
        mChart.setDescription("Platform Share");
    ...
    private void addData()
    {
        ...
        final ArrayList<PropertyProjects> values = databaseHelper.loadPropertyStatistic("Platforms", "Platform_id");
        ...
        // create pie data set
        final PieDataSet dataSet = new PieDataSet(yVals1, "Platform Share");
