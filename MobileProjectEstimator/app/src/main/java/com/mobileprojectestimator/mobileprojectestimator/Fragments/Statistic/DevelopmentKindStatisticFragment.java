...
public class DevelopmentKindStatisticFragment extends StatisticFragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        ImageView dot7 = (ImageView) myLayout.findViewById(R.id.dot7);
    ...
    private void addData()
    {
        ...
        ArrayList<PropertyProjects> values = databaseHelper.loadPropertyStatistic("DevelopmentTypes","DevelopmentKind_id");
        ...
        // create pie data set
        PieDataSet dataSet = new PieDataSet(yVals1, "Development Types");
