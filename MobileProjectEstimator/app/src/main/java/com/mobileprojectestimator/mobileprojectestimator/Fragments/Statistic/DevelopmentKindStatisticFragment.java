 ...
 */
public class DevelopmentKindStatisticFragment extends StatisticFragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        final ImageView dot7 = (ImageView) myLayout.findViewById(R.id.dot7);
        dot7.setBackgroundResource(R.drawable.circle_blue);

        final TextView tvTitle = (TextView) rootView.findViewById(R.id.tvTitle);
        tvTitle.setText(R.string.fragment_statistic_development_kind_title);

        mChart = (PieChart) rootView.findViewById(R.id.estimationMethodProjectsChart);

        // configure pie chart
        mChart.setUsePercentValues(true);
        mChart.setDescription("Development Types Share");
    ...
    private void addData()
    {
        ...
        final ArrayList<PropertyProjects> values = databaseHelper.loadPropertyStatistic("DevelopmentTypes", "DevelopmentKind_id");
        ...
        // create pie data set
        final PieDataSet dataSet = new PieDataSet(yVals1, "Development Types");
